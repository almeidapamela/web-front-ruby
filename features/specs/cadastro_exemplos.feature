...
Funcionalidade: Cadastrar Cliente
    ...
    Esquema do Cenário: Cadastrar cliente com dados válidos com exemplos
        ...
        Exemplos:
            ...
            | 'sextou104@gmail.com' | 'masc' | 'João'     | 'Silva'   | '12345'  | '10' | 'November' | '2000' | 'no'       | 'cwi'    | 'Rua dos bobos, 55' | 'poa' | 'Iowa' | '12345' | '5551998765456' | 'casa'        |
            | 'sextou105@gmail.com' | 'fem'  | 'Aline'    | 'Dantas'  | '54321'  | '20' | 'August'   | '1998' | 'yes'      | 'dbc'    | 'Lima e Silva, 10'  | 'poa' | 'Iowa' | '97500' | '5551998765456' | 'trabalho'    |